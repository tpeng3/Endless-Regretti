...
BasicGame.GamePlay.prototype = {
    ...
    create: function () {
        ...
        this.BULLET_INTERVAL = 4000; // time between bullets fired
    ...
    updatePlayer: function(){
        ...
        if(this.jumps > 0 && (this.input.keyboard.downDuration(Phaser.Keyboard.UP, 150) ||
            this.input.keyboard.downDuration(Phaser.Keyboard.W, 150) ||
            this.input.keyboard.downDuration(Phaser.Keyboard.SPACEBAR, 150))){
        ...
        if(this.jumping && (this.input.keyboard.upDuration(Phaser.Keyboard.UP) ||
            this.input.keyboard.upDuration(Phaser.Keyboard.W) ||
            this.input.keyboard.upDuration(Phaser.Keyboard.SPACEBAR))){
            player.animations.stop();
            this.jumps--;
            this.jumping = false;
        }
